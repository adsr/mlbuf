...
// srule functions
srule_t* srule_new_single(char* re, size_t re_len, sblock_t style);
srule_t* srule_new_multi(char* re, size_t re_len, char* re_end, size_t re_end_len, sblock_t style);
srule_t* srule_new_range(mark_t* range_a, mark_t* range_b, sblock_t style);
